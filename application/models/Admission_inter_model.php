   ...
   /* public function getreulefee($ruleID)
    ...
    public function Batch_Insertion($data)
    {
     // DebugBreak();
        ...
        $query = $this->db->query("Admission_online..Batch_Create_12th_2016_test $inst_cd,$reg_fee,$fine,$processing_fee,$total_std,$total_fee,$TotalRegFee,$Totalprocessing_fee,$TotalLatefee,'$todaydate','$forms_id',$cert_fee,$total_cert");
    }
