     ...
     public function Update_NewEnorlement($data)//$father_name,$bay_form,$father_cnic,$dob,$mob_number)  MA_P1_Reg_Adm2016_sp_Update
    {
      ...
      $grp_cd = $data['RegGrp'];
        ...
        $PicPath = $data['PicPath'];
         $year =  Year;
//       DebugBreak();
        $query = $this->db->query("Registration..IA_P1_Reg_Correction_sp_insert '$formno',11,$year,1,'$name','$fname','$BForm','$FNIC','$Dob',$grp_cd,$sub1,$sub2,$sub3,$sub4,$sub5,$sub6,$sub7,$sub8,$Pic,$Inst_cd,$RegGrp,$NameFee,$FnameFee,$BFormFee,$DobFee,$FNICFee,$grpFee,$subFee,$picFee,$totalFee,$AppNo");
      ...
      public function EditEnrolement($inst_cd)
    {
        ...
        $year = Year;
        $query = $this->db->query("Registration..sp_get_regInfo_Correction_11th $inst_cd,11,$year,1");    
    ...
    public function Print_challan_Form($fetch_data)
    {
        ...
        $formno = $fetch_data['formno'];
          $year = Year;
     // DebugBreak();
        $query = $this->db->query("Registration..sp_get_regInfo_correction_challan_11th $Inst_cd,11,$year,1,'$formno'");
        $rowcount = $query->num_rows();
        if($rowcount > 0)
        {
            return $query->result_array();
    ...
    public function EditEnrolement_Applied($inst_cd)
    {
        ...
        //sp_get_regInfo_spl_case
          $year = Year;
        $query = $this->db->query("Registration..sp_get_regInfo_after_Correction_11th $inst_cd,11,$year,1");    
    ...
    public function EditEnrolement_Branch()
    {
       ...
       // DebugBreak();
        ...
        //sp_get_regInfo_spl_case
        $year = Year;
        $query = $this->db->query("Registration..sp_get_regInfo_after_Correction_Branch_11th 11,$year,1");    
