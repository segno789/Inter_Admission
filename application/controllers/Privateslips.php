...
class Privateslips extends CI_Controller {
    ...
    */
    ...
    public function rollnumberslip9th_stopped()
    {
        $this->load->helper('url');
        $data = array(
            'message' => '',
    ...
    private function makepdf($pdf,$info)
    {
       ...
       // $pdf->Image("assets/pdfs/".$info['barcode'],126.0,15.1, 43.65,5.65, "PNG");  
        ...
        if(@$info['slips'][$countter]['subp1count'] +@$info['slips'][0]['subp2count'] <3)
        {
               $Y = 28+ $Y;
        }
        ...
        $pdf->Image("assets/img/Note00.jpg",10.0,264, 145,22, "JPG"); 
        $pdf->SetFont('Arial','',8);
        $pdf->SetXY(160,287);
