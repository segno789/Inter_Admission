...
<script type="">
 ...
 function checks(){
        ...
        else
        {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "Admission_11th_pvt/NewEnrolment_insert_lang/",
                dataType: 'html',
    ...
    $(function() {
      ...
      // ____________________ Already Appeared in Aloom-e-sharkia _________________

            $("#isAlreadyApplied").change(function () {

                if ($("#isAlreadyApplied").is(':checked')) {
                    $("#oldExamInfo_lang").show();
