            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>/index.php/Admission_inter/NewEnrolment_INSERT_inter" method="post" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    ...
                                    <img id="previewImg" style="width:80px; height: 80px;" class="span2" src="<?php  echo '/'; ?>" alt="Candidate Image">
                                 <input type="hidden" value="<?=$Inst_Id?>" name="pic">
                                </div>
                            </div>
                            <div class="control-group">
