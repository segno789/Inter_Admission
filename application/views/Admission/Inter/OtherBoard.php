    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-offset-2 col-md-4"><label class="control-label">Roll No :</label>
                <input class="text-uppercase form-control" type="text" id="oldrno" name="oldrno" readonly="readonly" value="<?php echo  @$data['SSC_RNO']; ?>" required="required" maxlength="10">
            </div>
            <div class="col-md-4">
                <label class="control-label">Year:</label> 
                <input type="text" class="text-uppercase form-control" name="oldyear" id = "oldyear" readonly="readonly" value="<?php  echo @$data['SSC_Year']; ?>"/> 
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-offset-2 col-md-4"><label class="control-label">Session:</label>
                <input type="text" class="text-uppercase form-control" id="oldsess" name="oldsess" readonly="readonly" value="<?php echo @$data['SSC_Session'] == 1 ? "Annual" :"Supplementary"; ?>"/> 
            </div>
            <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-offset-2 col-md-3">
                <input type="submit" value="Save Form" id="btnSaveFresh" name="btnsubmitUpdateEnrol" id="btnsubmitUpdateEnrol" class="btn btn-primary btn-block"  onclick="return checks_otherBoard_Pre_10th(this)" >
            </div>
            <div class="col-md-2">
...
<script type="text/javascript">
    ...
    function checks_otherBoard_Pre_10th()
    {   
