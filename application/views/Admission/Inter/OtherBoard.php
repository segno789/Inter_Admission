            ...
            <div class="span12">
                <div class="widget">
                    ...
                    <div class="widget-body" >
                        <form class="form-horizontal no-margin" action="<?php  echo base_url(); ?>Admission/NewEnrolment_insert_Fresh_OtherBoard" method="post" enctype="multipart/form-data" name="myform" id="myform">
