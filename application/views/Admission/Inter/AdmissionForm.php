                            ...
                            <div class="control-group">
                                ...
                                <div class="controls controls-row">
                                    <select id="std_group" class="dropdown span6"  name="std_group">
                                        ...
                                        echo "<option value='9'>ALOOM-E-SHARKIA</option>";    
                                        echo "<option value='10'>KHASA</option>";    
                                        echo "<option value='11'>FAZAL</option>";    

                                        //DebugBreak();

                                        /*if(($class == 11 || $class == 12) && ($IsRegular == 2 || $coll_cd == 999999)){
                                        ...
                                        {
                                        echo "<option value='6' selected='selected'>ISLAMIC STUDIES</option>";  
                                        }
                                        ...
                                        {
                                        echo "<option value='10' selected='selected'>KHAASA</option>";  
                                        }

                                        else if($grp == 11)
                                        {
                                        echo "<option value='11' selected='selected'>FAAZAL</option>";  
                                        }

                                        }
                                        if(($class == 11 || $class == 12) && ($IsRegular == 1)){
                                        echo "<option value='5' selected='selected'>COMMERCE</option>";  
                                        echo "<option value='3' selected='selected'>HUMANITIES</option>";  
                                        echo '<script type="text/javascript">    remove_subjects();      </script>';
                        ...
                        <script type="text/javascript">
                            ...
                            $(document).ready(function(){
                                ...
                                function sub_grp_load(){
                                    ...
                                    //"#lblpart1cat").text("Category P-1: MARKS IMPROVEMENT");
