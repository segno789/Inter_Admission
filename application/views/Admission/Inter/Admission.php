            ...
            <div class="span12">
                <div class="widget no-margin">
                    ...
                    <div class="widget-body">
                        <h1    style="text-align: center;"><font color="#000000" size="+1" >Note:-Last Date of Online Admission for 12th is <b class="blink_text"><?php echo SingleDateFee; ?></b></font></h1>
                        ...
                        <div style="margin-left: 20px;font-size: 16px;">
                            ...
                            with your <span style="font-weight:bolder; "> User Id, Contact No. </span>  and description of problem. <br />
