            ...
            <div class="span12">
                <div class="widget no-margin">
                    <div class="widget-header">
                        <div class="title">
                            Batch List Matric Admission Form<a data-original-title="" id="notifications">s</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    if($info!= false)
                                    {
                                        ...
                                        foreach($Inst_Cd = $info as $key=>$vals):
                                            ...
                                            <td>
                                            <button type="button" class="btn btn-info" value="'.$vals['Batch_ID'].'" onclick="CutList('.$vals['Batch_ID'].')">Cut List</button>
