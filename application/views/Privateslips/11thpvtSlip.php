...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div class="main_bg_container">
            <div id="header">
                <div class="inHeaderLogin">
                    ...
                    <!--Intimation-->
                    <p style="color: wheat;text-align: center;font-size: 23px;margin-left: 28px;float: left;  margin-top:35px;">Board of Intermediate & Secondary Education, Gujranwala </br></br> Download Roll Number Slip For 11th Annual <?= mYear?></p>
                </div>
            </div> 
            <div id="wraper2">
                <fieldset >
 ...
 <br />
                        ...
                        <div class="persnal_info">
                            ...
                            <form name="std_fth_dob_frm" id="std_fth_dob_frm" action="<?=base_url()?>Privateslips/Get11thpvtRSlip" method="post">
                                <fieldset >
                        ...
                        <div class="Form_NO">
                            ...
                            <form name="formno" id="formno" action="<?=base_url()?>Privateslips/Get11thpvtRSlip" method="post">
                                <fieldset>
                                    <div class="student_info">
                        ...
                        <div class="Roll_NO">
                            ...
                            <form name="cur_exm_roll_frm" id="cur_exm_roll_frm" action="<?=base_url()?>Privateslips/Get11thpvtRSlip/" method="post">
                                <fieldset>
                                    <div class="student_info">
